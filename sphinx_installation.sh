sudo apt-get install -y  python3-sphinx sphinx-rtd-theme-common python3-sphinx-rtd-theme jupyter-sphinx-theme-doc python3-jupyter-sphinx python-nbsphinx-doc python3-nbsphinx python3-nbsphinx-link

sudo apt install nexus-tools npm nodejs
